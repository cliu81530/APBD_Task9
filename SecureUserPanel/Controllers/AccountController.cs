...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
    {
        ...
        bool emailTaken = await _db.AppUsers.AnyAsync(u => u.Email == model.Email);
        if (emailTaken)
        {
            ModelState.AddModelError(string.Empty, "Registration failed. Please try different credentials.");
            return View(model);
        }
